...
function generateResults(measurement, height, weight, gender) {
	...
	const results = {
		...
		ectomortph: ectomortph(ponderalIndex(height, weight)),
		resultX: resultX(ectomortph(ponderalIndex(height, weight)), endomorph(measurement, height)),
		resultY: resultY(ectomortph(ponderalIndex(height, weight)), endomorph(measurement, height), mesomorph(measurement, height)),
		...
		sumaPlieguesEndo: sumaPlieguesEndo(measurement, gender),
		...
		parizcovaFatPercentage: parizcovaFatPercentage(measurement, gender),
		...
		desiredFat2MethodPercentage: desiredFat2MethodPercentage(measurement, weight, gender)
	};
	console.log({results});
	return results;
}
