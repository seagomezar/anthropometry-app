...
describe('Food', () => {
    beforeEach(() => {
      ...
      cy.visit('http://localhost:3000/nutrition-app#/food')
    })
    ...
    it('Crear Food', () => {
        ...
        cy.get("#calories").type("23");
        cy.get("#chos").type("12");
        cy.get("#description").type("jugo de tomate");
        cy.get("#fat").type("1");
        cy.get("#measure_unit").type("vazo");
        cy.get("#protein").type("10");
        ...
        cy.get("#root > div > div > div > div > main > div.MuiDrawer-root.MuiDrawer-docked.RaSidebar-docked.css-9lo51-MuiDrawer-docked-RaSidebar-root > div > div > ul > a.MuiButtonBase-root.MuiMenuItem-root.MuiMenuItem-gutters.MuiMenuItem-root.MuiMenuItem-gutters.RaMenuItemLink-active.css-krc73u-MuiButtonBase-root-MuiMenuItem-root-RaMenuItemLink-root").click();
        cy.get("#" + Cypress.$.escapeSelector("description@_like")).click();
        cy.get("#" + Cypress.$.escapeSelector("description@_like")).type("jugo de tomate");
        cy.get("tr").should('have.length', 2); 
        cy.get("#main-content > div > div > div.MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.MuiPaper-elevation1.MuiCard-root.RaList-content.css-bhp9pd-MuiPaper-root-MuiCard-root > div > div.RaDatagrid-tableWrapper > table > tbody > tr:nth-child(1) > td:nth-child(13) > button").click();
