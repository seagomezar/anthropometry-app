...
describe('FoodCategory', () => {
    beforeEach(() => {
      ...
      cy.visit('http://localhost:3000/nutrition-app#/food_category')
    })

    it('Crear food_category', () => {
       ...
       cy.get("#" + Cypress.$.escapeSelector("name@_like")).type("gaseosa");
       cy.get("tr").should('have.length', 2); 
       cy.get("#main-content > div > div > div.MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.MuiPaper-elevation1.MuiCard-root.RaList-content.css-bhp9pd-MuiPaper-root-MuiCard-root > div > div.RaDatagrid-tableWrapper > table > tbody > tr:nth-child(1) > td:nth-child(7) > button").click();
